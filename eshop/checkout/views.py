...
def paypal_form(request):
    ...
    return render(request, 'checkout/paypal_integration.html', {'form': form})
...
def payment_completed(request):
    ...
    if Order.objects.filter(order_key = order_key).exists():
        ...
        order = Order.objects.create(user_id = user_id, full_name = 'full', address1 = 'add1', phone = '0853789410',
